...
class TestFiltrarHistorial6Meses:
    ...
    def test_log_informa_cantidad_filtrada(
        ...
        import src.tools.crear_notas_clinicas as cnc
        ...
        try:
            with caplog.at_level(logging.INFO):
                filtrar_historial_ultimos_6_meses(
                    h, "25-08-2026", logger=cnc_logger
                )
            assert any(
                "ultimos 6 meses" in rec.message
                and "1 anteriores descartadas" in rec.message
