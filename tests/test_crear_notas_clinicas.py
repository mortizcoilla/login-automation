...
class TestGuardarNotaClinicaNoSobrescribe:
    ...
    def test_sobreescribe_archivo_extraccion_rota(
        ...
        assert "panel del paciente NO CARGO" not in contenido
        # La anamnesis cruda NUEVA esta presente (regla Yadira 2026-09-16
        # corregido: el bloque Yadira contiene la anamnesis, no placeholder).
        assert "control de su patologia cronica" in contenido
        # El placeholder viejo NO esta.
        assert "bloque a completar por el LLM" not in contenido
